    ...
    <form onSubmit={onSubmit} style={{ display: "grid", gap: 18, maxWidth: 640 }}>
      ...
      <div>
        <label style={labelStyle}>
          ...
          required; <span className="mono">type</span>, <span className="mono">priority_tier</span>,{" "}
          <span className="mono">volume</span> optional (extra columns are ignored). Set once — every future
          run reuses this list, no re-upload needed.
        </label>
